...
<div class="display-2 pt-4 pb-0 text-end bg-light">
    <div class="container">
        ...
        <span class="gradient-text">StayHere.com.</span>
    </div>
</div>
            ...
            <div class="col-md-4">
                <div class="position-sticky" style="top: 2rem">
                    <div class="p-4 mb-3 bg-light rounded">
                        <h4 class="fst-italic">About <span class="gradient-text">StayHere.com.</span></h4>
                        <p class="mb-0">
                            StayHere.com is an hotel online booking platform. We aim to help you find the right hotel fo the right price, at your easiest convenience.
                        </p>
                    </div>
